<template>
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<view class="main">
				<wInput v-model="userInfo.username" type="text" maxlength="11" placeholder="用户名"></wInput>
				<wInput v-model="userInfo.password" type="password" maxlength="11" placeholder="密码"></wInput>
			</view>
			...
			<view class="footer">
				...
				<text>|</text> -->
				<navigator url="register?nav=注册账号" open-type="navigate">注册账号</navigator>
			</view>
		</view>
	</view>
</template>
